...
DEFAULT_PRIMARY_METRICS = (
    ...
    "eval/.episodic_precision_success_0p02",
    "eval/.episodic_precision_success_0p04",
    "eval/.episodic_precision_success_0p08",
    "rollout/.episodic_return",
    "rollout/.normalized_return",
    "rollout/.episodic_success",
    "rollout/.episodic_precision_success_0p02",
    "rollout/.episodic_precision_success_0p04",
    "rollout/.episodic_precision_success_0p08",
    "eval_best/.episodic_return",
    "eval_best/.normalized_return",
    "eval_best/.episodic_success",
    "eval_best/.episodic_precision_success_0p02",
    "eval_best/.episodic_precision_success_0p04",
    "eval_best/.episodic_precision_success_0p08",
    "eval/episodic_return",
    "eval/normalized_return",
    "eval/episodic_success",
    "eval/episodic_precision_success_0p02",
...
DEFAULT_DIAGNOSTIC_METRICS = (
    ...
    "eval/.gate_crossing_y_error_final",
    "eval/.gate_crossing_recorded_final",
    "eval/.z-rank-1",
    "eval_best/.comms_bits",
    ...
    "eval_best/.control/action_saturation_frac",
    "eval_best/.control/state_norm_max",
    "eval_best/.control/state_delta_norm_mean",
    "train/enc_loss",
    "train/tc_loss",
    "train/reward_loss",
    "train/q_loss",
...
CONFIG_KEYS_OF_INTEREST = (
    ...
    "agent.ddcl_delta",
    "agent.ddcl_scale",
    "agent.ddcl_deterministic_eval",
    "agent.ddcl_deterministic_targets",
    "agent.unc_prop_mode",
    "agent.plan_unc_prop_mode",
