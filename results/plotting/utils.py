...
YLABELS = {
    ...
    "normalized_return": "Normalized Return",
    "episodic_success": "Success Rate",
    "episodic_precision_success_0p02": "Precision Success (delta=0.02)",
    "episodic_precision_success_0p04": "Precision Success (delta=0.04)",
    "episodic_precision_success_0p08": "Precision Success (delta=0.08)",
    "gate_crossing_y_error_final": "Gate Crossing Error",
